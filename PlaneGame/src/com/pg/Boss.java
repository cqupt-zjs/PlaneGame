...
public class Boss {
	...
	public BossData getBossData(){
		...
		bd.setCount(count);
		bd.setCrazy(isCrazy);
		bd.setCrazyTime(crazyTime);
		bd.setFrameH(frameH);
		bd.setFrameIndex(frameIndex);
		bd.setFrameW(frameW);
		bd.setHp(hp);
		bd.setSpeed(speed);
		bd.setX(x);
	...
	public void setBossData(BossData bd){
		this.count=bd.getCount();
		this.crazyTime=bd.getCrazyTime();
		this.frameH=bd.getFrameH();
		this.frameW=bd.getFrameW();
		this.frameIndex=bd.getFrameIndex();
		this.x=bd.getX();
		this.y=bd.getY();
		this.hp=bd.getHp();
		this.isCrazy=bd.isCrazy();
