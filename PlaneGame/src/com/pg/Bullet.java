...
public class Bullet implements Serializable {
	...
	//子弹当前方向
	public Bullet(Bitmap bmpBullet ) {
	...
	public BulletData getBulletData(){
		...
		bd.setBulletType(bulletType);
		bd.setBulletX(bulletX);
		bd.setBulletY(bulletY);
		bd.setDead(isDead);
		bd.setDir(dir);
		bd.setSpeed(speed);
		return bd;
	...
	public void setBulletData(BulletData bd){
		this.bulletType=bd.getBulletType();
		this.bulletX=bd.getBulletX();
		this.bulletY=bd.getBulletY();
		this.dir=bd.getDir();
		this.isDead=bd.isDead();
		this.speed=bd.getSpeed();
